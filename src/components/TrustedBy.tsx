...
const CityMDLogo = () => (
  <div className="flex items-center gap-2 text-normalGray opacity-60">
    ...
    <span className="text-xl font-bold tracking-tight">City<span className="font-extrabold">MD</span></span>
  </div>
)
...
const GilletteLogo = () => (
  <div className="flex items-center gap-1 text-normalGray opacity-60">
    ...
    <div className="flex flex-col">
      <span className="text-lg font-bold tracking-tight leading-none">gillette</span>
      <span className="text-[10px] font-medium tracking-widest uppercase leading-none">Children&apos;s</span>
    </div>
  </div>
)
