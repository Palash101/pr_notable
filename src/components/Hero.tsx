      ...
      <section className="relative overflow-hidden bg-white p-3">
        <div className="container">
          <div className="flex flex-col gap-20">
            <div className="top-banner hidden md:flex justify-between items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start md:items-center">
              {/* Left Content */}
              <div className="space-y-6 animate-fade-in order-1 lg:order-1">
                <h1 className="text-2xl md:text-text43">
                ...
                <p className="text-text13 md:text-base font-normal text-normalGray leading-relaxed max-w-xl">
              ...
              <div
                className={`group-hover:scale-125 transition-transform duration-500 animate-pulse-hard order-2 lg:order-2`}
              >
                <Image
