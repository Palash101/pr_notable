              ...
              <div className="container-medium">
                <div className="padding-section-large pt-24 pb-11 padding-bottom-none">
                  <div className="text-center">
                    {/* FLOW BUILDER */}
                    <div className="eyebrow text-blue-600 text-lg font-medium tracking-wider mb-4">
                      FLOW BUILDER
                    </div>
                    ...
                    {/* Main heading */}
                    <h1 className="text-6xl font-light text-blue-900 mb-6">
                      What will you build?
                    </h1>
          ...
          <div className="padding-global">
            <div className="container-medium">
              <div className="center-heading-wrapper flowbuilder_split-header">
                ...
                <h1
                  className="heading-style-h2 text-wrap-balance text-4xl font-light text-blue-900 mb-6"
                  style={{
                    opacity: 1,
                    transform:
                ...
                <div className="align-center max-width-medium">
                  <p
                    className="text-color-secondary text-gray-600 text-lg leading-relaxed"
                    style={{
                      opacity: 1,
                      transform:
                        "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
              ...
              <div className="flex flex-col items-center">
                <div className="flow-split_content">
                  <div className="margin-bottom margin-medium">
                    <div
                      className="eyebrow is-small text-color-primary"
                      style={{
                        opacity: 1,
                        transform:
                          "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
